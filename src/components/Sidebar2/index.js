            ...
            <Column className="flex flex-col justify-start sm:mb-[224px] md:mb-[289px] mb-[421px] sm:mt-[19px] md:mt-[24px] mt-[36px] sm:mx-[0] pt-[1px] sm:px-[0] sm:w-[100%] w-[88%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[18px] md:mt-[23px] mt-[34px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[46%]">
                <Img
                  ...
                  alt="trash"
                />
                <Text className="flex-grow font-inter font-medium mb-[1px] md:ml-[11px] ml-[16px] sm:ml-[8px] sm:mt-[2px] md:mt-[3px] mt-[5px] text-[14px] text-bluegray_400">
                  Shop
                </Text>
              </Row>
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[16px] md:mt-[21px] mt-[31px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[62%]">
                ...
                <Text className="font-inter font-medium mb-[2px] ml-[13px] sm:ml-[6px] md:ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[7px] text-[14px] text-bluegray_800 w-[auto]">
                  Settings
                </Text>
              </Row>
            </Column>
