                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap font-inter items-center justify-between sm:mt-[20px] md:mt-[26px] mt-[38px] w-[100%]">
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center sm:mx-[0] sm:p-[15px] md:p-[17px] p-[26px] rounded-radius4 shadow-bs sm:w-[100%] w-[75%]">
                    <Column className="flex flex-col items-center justify-start sm:mb-[3px] md:mb-[4px] mb-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                      ...
                      <Stack className="h-[642px] sm:mt-[15px] md:mt-[20px] mt-[30px] relative w-[100%]">
                        <Column className="absolute border border-indigo_51 border-solid bottom-[0] flex flex-col items-center justify-start p-[4px] w-[100%]">
                          <Row className="bg-indigo_400 flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mb-[295px] md:mb-[382px] mb-[556px] mt-[1px] p-[4px] rounded-radius4 w-[100%]">
                            <Img
                              src="images/img_oval.svg"
                              className="max-w-[100%] ml-[12px] sm:ml-[6px] md:ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[7px] w-[1%]"
                              alt="Oval"
                            />
                            <Text
                              className="font-medium ml-[13px] sm:ml-[6px] md:ml-[8px] text-white_A700 w-[auto]"
                              as="h6"
                              variant="h6"
                            >
                              8:10 am
                            ...
                            <Text
                              className="font-semibold mb-[4px] sm:ml-[4px] md:ml-[6px] ml-[9px] text-white_A700 w-[auto]"
                              as="h6"
                              variant="h6"
                            >
                        ...
                        <Button
                          className="absolute cursor-pointer font-semibold text-[16px] text-bluegray_800 text-center top-[0] w-[100%]"
                          size="md"
                          variant="OutlineIndigo51"
                        >
                          Friday
